...
def main():
    ...
    st_copy_to_clipboard("The length of the content I need to send is too big to be sent all at once.\n\nI will follow this rule when sending you the content:\n\n[START PART 1/X]\nThis is the first part out of a total of X.\n[END PART 1/X]\n\nYou can simply respond with 'Acknowledged receipt of part 1 of X'.\n\nAnd when I tell you 'ALL PARTS SENT', then you can continue processing the data and answering my requests.\n\nOnce I have confirmed that all parts have been sent, please proceed with processing the data and fulfilling my requests promptly.", "Copy instructions")
    ...
    if 'parts' in st.session_state:
        for i, part in enumerate(st.session_state.parts, 1):
            ...
            st_copy_to_clipboard(text, f"Copy Part {i}")
